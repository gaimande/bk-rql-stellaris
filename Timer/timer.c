...
//
//*****************************************************************************
#define LED_PORT_BASE GPIO_PORTA_BASE
...
Timer0IntHandler(void)
{
	...
	fuck = ~fuck;
	ROM_GPIOPinWrite(LED_PORT_BASE, LED_PIN1, fuck);
    ROM_IntMasterEnable();
}
...
Timer1IntHandler(void)
{
    ...
    UARTprintf("\rT1: %d  T2: %d", HWREGBITW(&g_ulFlags, 0) ? 1 : 0,
               HWREGBITW(&g_ulFlags, 1) ? 1 : 0);
	fuck2 = ~fuck2;
	ROM_GPIOPinWrite(LED_PORT_BASE, LED_PIN2, fuck2);
    ROM_IntMasterEnable();
}
...
main(void)
{
    ...
    //
    ROM_GPIOPinTypeGPIOOutput(LED_PORT_BASE, LED_PIN1);
	ROM_GPIOPinTypeGPIOOutput(LED_PORT_BASE, LED_PIN2);
